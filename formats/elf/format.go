...
const (
	...
	SECTION_TYPE_SYMTAB_SHNDX        = 18
	SECTION_TYPE_LOOS                = 0x60000000
	SECTION_TYPE_ANDROID_REL         = 0x60000001
	SECTION_TYPE_ANDROID_RELA        = 0x60000002
	SECTION_TYPE_LLVM_ODRTAB         = 0x6fff4c00
	SECTION_TYPE_LLVM_LINKER_OPTIONS = 0x6fff4c01
	SECTION_TYPE_GNU_ATTRIBUTES      = 0x6ffffff5
	SECTION_TYPE_GNU_HASH            = 0x6ffffff6
	SECTION_TYPE_GNU_VERDEF          = 0x6ffffffd
	SECTION_TYPE_GNU_VERNEED         = 0x6ffffffe
	SECTION_TYPE_GNU_VERSYM          = 0x6fffffff
	SECTION_TYPE_HIOS                = 0x6fffffff
	SECTION_TYPE_LOPROC              = 0x70000000
	SECTION_TYPE_HEX_ORDERED         = 0x70000000
	SECTION_TYPE_ARM_EXIDX           = 0x70000001
	SECTION_TYPE_X86_64_UNWIND       = 0x70000001
	SECTION_TYPE_ARM_PREEMPTMAP      = 0x70000002
	SECTION_TYPE_ARM_ATTRIBUTES      = 0x70000003
	SECTION_TYPE_ARM_DEBUGOVERLAY    = 0x70000004
	SECTION_TYPE_ARM_OVERLAYSECTION  = 0x70000005
	SECTION_TYPE_MIPS_REGINFO        = 0x70000006
	SECTION_TYPE_MIPS_OPTIONS        = 0x7000000d
	SECTION_TYPE_MIPS_DWARF          = 0x7000001e
	SECTION_TYPE_MIPS_ABIFLAGS       = 0x7000002a
	SECTION_TYPE_HIPROC              = 0x7fffffff
	SECTION_TYPE_LOUSER              = 0x80000000
	SECTION_TYPE_HIUSER              = 0xffffffff
)
